...
public class GraphViz
{
     ...
     */
  private static String TEMP_DIR = "D:\\a";

    /**
     * Where is your dot program located? It will be called externally.
     */
  private static String DOT="C:\\Program Files (x86)\\Graphviz2.38\\bin\\dot.exe";// = configFile.getProperty("dotFor" + osName);
     ...
     */
    private int currentDpiPos = dpiSizes.length-1;
    ...
    private byte[] get_img_stream(File dot, String type)
    {
        ...
        try {
            img = File.createTempFile("graph_", "."+type, new File("D:\\"));
    ...
    private File writeDotSourceToFile(String str) throws java.io.IOException
    {
        File temp;
        try {
            temp = File.createTempFile("dot",".dot", new File("D:\\"));
